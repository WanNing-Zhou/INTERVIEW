...
## <h2 id="4">v-show和v-if指令的共同点和不同点？</h2>
...
## <h2 id="17">vue组件中data为什么必须是一个函数？</h2>
...
## <h2 id="23">created和mounted的区别</h2>
